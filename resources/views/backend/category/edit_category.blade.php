...
@section('main')
        ...
        <div class="container">
            ...
            <form action="{{route('store.update',$category->id)}}" method="POST"  class="row g-3 justify-content-center">
                @csrf
            ...
            @enderror
                <div class="col-md-5" >
                    <input type="text" class="form-control shadow @error('category_name') is-invalid @enderror" value="{{ $category->category_name }}" name="category_name"  placeholder="category Name">
                </div>
